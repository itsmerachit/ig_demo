"""
Django settings for ig_backend project.
...
SECRET_KEY = '#d()f*(+f+$s+4a^_-q#kcip*zm+mh+vrhzt9c-kcxhs6ie=pr'
...
WSGI_APPLICATION = 'ig_backend.wsgi.application'
